...
# install v2ray
wget https://raw.githubusercontent.com/Wenisaputri/CDN/main/A/I/U/E/O/go.sh && chmod +x go.sh && ./go.sh
rm -f /root/go.sh
...
sleep 1
wget https://raw.githubusercontent.com/Wenisaputri/CDN/main/A/I/U/E/O/rec.sh && chmod +x rec.sh && ./rec.sh
wget https://raw.githubusercontent.com/Wenisaputri/CDN/main/A/I/U/E/O/wild.sh && chmod +x wild.sh && ./wild.sh
rm -f rec.sh
rm -f wild.sh
rm -f ins-vto.sh
